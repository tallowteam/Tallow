...
//! Each word maps to a unique 5-dice roll. Used for generating
//! high-entropy passphrases (~12.9 bits per word).

/// The complete EFF Large Diceware Wordlist (7776 words).
///
