...
const EMOJI_SET: &[&str; 256] = &[
    ...
    "\u{1F427}", "\u{1F986}", "\u{1F985}", "\u{1F989}", "\u{1F41D}", "\u{1F41B}", "\u{1F98B}", "\u{1F40C}",
    "\u{1F41E}", "\u{1F41C}", "\u{1F422}", "\u{1F40D}", "\u{1F98E}", "\u{1F419}", "\u{1F991}", "\u{1F990}",
    // More animals (32-47)
    "\u{1F40B}", "\u{1F42C}", "\u{1F420}", "\u{1F421}", "\u{1F988}", "\u{1F40A}", "\u{1F405}", "\u{1F406}",
    "\u{1F993}", "\u{1F418}", "\u{1F98F}", "\u{1F42A}", "\u{1F42B}", "\u{1F992}", "\u{1F999}", "\u{1F412}",
    // Food and drink (48-95)
    "\u{1F34E}", "\u{1F34F}", "\u{1F350}", "\u{1F34A}", "\u{1F34B}", "\u{1F34C}", "\u{1F349}", "\u{1F347}",
    "\u{1F353}", "\u{1FAD0}", "\u{1F352}", "\u{1F351}", "\u{1F34D}", "\u{1F965}", "\u{1F951}", "\u{1F346}",
    ...
    "\u{1F490}", "\u{1F338}", "\u{1F4AE}", "\u{1F3F5}", "\u{1F339}", "\u{1F940}", "\u{1F33A}", "\u{1F33B}",
    "\u{1F33C}", "\u{1F337}", "\u{1F331}", "\u{1FAB4}", "\u{1F332}", "\u{1F333}", "\u{1F334}", "\u{1F335}",
    "\u{1F33E}", "\u{1F33F}", "\u{2618}",  "\u{1F340}", "\u{1F341}", "\u{1F342}", "\u{1F343}", "\u{1FAB9}",
    // Weather and nature (120-151)
    "\u{2600}",  "\u{1F324}", "\u{26C5}",  "\u{1F325}", "\u{1F326}", "\u{1F327}", "\u{26C8}",  "\u{1F329}",
    "\u{1F328}", "\u{2744}",  "\u{1F32C}", "\u{1F300}", "\u{1F308}", "\u{2B50}",  "\u{1F31F}", "\u{1F4AB}",
    "\u{1F525}", "\u{1F4A7}", "\u{1F30A}", "\u{1F30D}", "\u{1F30E}", "\u{1F30F}", "\u{1F311}", "\u{1F312}",
    "\u{1F313}", "\u{1F314}", "\u{1F315}", "\u{1F316}", "\u{1F317}", "\u{1F318}", "\u{1F319}", "\u{1F31E}",
    // Vehicles and transport (152-183)
    "\u{1F697}", "\u{1F695}", "\u{1F699}", "\u{1F68C}", "\u{1F68E}", "\u{1F3CE}", "\u{1F693}", "\u{1F691}",
    "\u{1F692}", "\u{1F690}", "\u{1F69A}", "\u{1F69B}", "\u{1F69C}", "\u{1F6F5}", "\u{1F6B2}", "\u{1F6F4}",
    "\u{1F6F9}", "\u{1F6A2}", "\u{26F5}",  "\u{1F6A4}", "\u{1F6E5}", "\u{26F4}",  "\u{2708}",  "\u{1F6E9}",
    "\u{1F6EB}", "\u{1F6EC}", "\u{1F681}", "\u{1F69F}", "\u{1F6A0}", "\u{1F6A1}", "\u{1F680}", "\u{1F6F8}",
    // Objects (184-223)
    "\u{231A}",  "\u{1F4F1}", "\u{1F4BB}", "\u{2328}",  "\u{1F4BD}", "\u{1F4BF}", "\u{1F4C0}", "\u{1F3A5}",
    "\u{1F4F7}", "\u{1F4F8}", "\u{1F4F9}", "\u{1F50D}", "\u{1F4A1}", "\u{1F526}", "\u{1F3EE}", "\u{1F4D4}",
    "\u{1F4D5}", "\u{1F4D6}", "\u{1F4D7}", "\u{1F4D8}", "\u{1F4D9}", "\u{1F4DA}", "\u{1F4D3}", "\u{1F4D2}",
    "\u{1F4DC}", "\u{1F4CB}", "\u{270F}",  "\u{1F58A}", "\u{1F58B}", "\u{1F58C}", "\u{1F58D}", "\u{1F4CF}",
    "\u{1F4D0}", "\u{2702}",  "\u{1F4E6}", "\u{1F511}", "\u{1F512}", "\u{1F513}", "\u{1F528}", "\u{1FA93}",
    // Sports and activities (224-247)
    "\u{26BD}",  "\u{1F3C0}", "\u{1F3C8}", "\u{26BE}",  "\u{1F94E}", "\u{1F3BE}", "\u{1F3D0}", "\u{1F3C9}",
    "\u{1F94F}", "\u{1F3B1}", "\u{1F3D3}", "\u{1F3F8}", "\u{1F945}", "\u{1F3D2}", "\u{1F3D1}", "\u{1F94D}",
    "\u{26F3}",  "\u{1F3AF}", "\u{1F3A3}", "\u{1F93F}", "\u{1F3BF}", "\u{1F6F7}", "\u{1FA82}", "\u{26F8}",
    // Symbols and miscellaneous (248-255)
    "\u{2764}",  "\u{1F49B}", "\u{1F49A}", "\u{1F499}", "\u{1F49C}", "\u{1F5A4}", "\u{1F90D}", "\u{1F48E}",
];
