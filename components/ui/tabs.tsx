...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted/50 text-foreground inline-flex h-10 w-fit items-center justify-center rounded-lg p-1 border border-border/50",
        className
      )}
      {...props}
    />
