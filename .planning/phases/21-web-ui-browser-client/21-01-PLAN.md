...
must_haves:
  truths:
    ...
    - "ML-KEM-1024 key generation, encapsulation, and decapsulation work identically in WASM and native"
    - "AES-256-GCM encrypt/decrypt round-trips produce identical ciphertext in WASM and native"
    - "BLAKE3 hashing produces identical output in WASM and native"
    - "postcard-encoded Message variants decode identically in WASM and native"
  artifacts:
