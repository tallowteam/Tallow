...
- suppression directive found: components/transfer/QRScanner.tsx
- suppression directive found: components/ui/AnimatedSection.tsx
- suppression directive found: lib/auth/webauthn-store.ts
- suppression directive found: lib/auth/webauthn.ts
- suppression directive found: lib/cli-bridge/cli-protocol.ts
- suppression directive found: lib/utils/cache-buster.ts
- suppression directive found: lib/utils/device-detection.ts
